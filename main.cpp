...
int main() {
    ...
    AdditiveFrequencyBased(cipher_text);
    //
    cipher_text =
        "lmqetxyeagtxctuiewnctxlzewuaispzyvapewlmgqwyaxftcjmsqcadagtxlmdxnxsnpjqsyvapriqsmhnocvaxf"
        "v";
    HillFrequencyAttack(cipher_text, 3);

    cipher_text =
        "HUDSKUAEZGXRAVTFPGWSWGWSZHTPPBILLRTZPZHWLOIJVFICVBTHLUGILGPRKHWMYHTIUAXRBHTWUCGXOSPWAOCHIM"
        "CSYHWQHWCFYOCGOGTZLBILSWBFLOHXZWSIZVDSATGSTHWISSUXLMTSMHWIKSPXOGWIHRPFLSAMUSUVVAILLHGILHWV"
        "VIVLAVTWOCIJPTICMSTXVII";
    //    cipher_text =
